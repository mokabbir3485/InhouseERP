app.controller("SupplierEntryController", function ($scope, $rootScope, $http, $window) {
      //For Screen lock
    ...
    //$scope.ScreenId = parseInt(sessionStorage.getItem("SupplierScreenId"));
    ...
    $scope.ScreenId = Permission.find(v => v.ScreenName == 'Supplier').ScreenId;
    ...
    $scope.SupplierNameSearch = function () {
        GetSupplierPaged(1);
    ...
    function GetSupplierPaged(curPage) {
        ...
        var SearchCriteria = "";
        if ($scope.SupplierName != undefined && $scope.SupplierName != "") {
            SearchCriteria = "[SupplierName] LIKE '%" + $scope.SupplierName + "%'";
        }

        $http({
            url: encodeURI("/Supplier/GetSupplierPaged?StartRecordNo=" + StartRecordNo + "&RowPerPage=" + $scope.PerPage + "&whereClause=" + SearchCriteria + "&rows=" + 0),
            method: 'GET',
            headers: { 'Content-Type': 'application/json' }
        }).success(function (data) {
    ...
    function GetSupplierAddress(SupplierId) {
        $http({
            url: '/Supplier/GetSupplerAddressById',
            method: "GET",
    ...
    function ClearSupplierAddress() {
        $scope.ad_SupplierAddress = new Object();
        $scope.ad_SupplierAddress.AddressType = 'Billing';
    ...
    $scope.AddSupplierAddress = function () {
        if ($scope.ad_SupplierAddress.AddressType != "" || $scope.ad_SupplierAddress.AddressType != undefined) {
    ...
    $scope.CheckDefault = function (defaultAdd) {
        ...
        if (defaultAdd) {
            angular.forEach($scope.supplierAddresslist, function (address) {
                //if ($scope.ad_SupplierAddress.AddressType == 'Delivery') {
                ...
                //    }
                //}
                if ($scope.ad_SupplierAddress.AddressType == 'Billing') {
                ...
                //if ($scope.ad_SupplierAddress.AddressType == 'Mailing') {
                ...
                //    }
                //}
                //if ($scope.ad_SupplierAddress.AddressType == 'DeliveryPoint') {
                //    if (address.Status == 'Yes' && address.AddressType == 'DeliveryPoint') {
                //        alertify.log('One Default Delivery Point Address Accepted!', 'error', '5000');
                //        $scope.ad_SupplierAddress.IsDefault = false;
                //        return;
                //    }
                //}
