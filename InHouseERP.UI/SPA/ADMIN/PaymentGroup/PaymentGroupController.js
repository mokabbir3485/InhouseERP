app.controller("PaymentGroupController", function ($scope, $rootScope, $route, $http, $window) {
    var UserData = sessionStorage.getItem("UserDataSession");
    if (UserData != null) {
        $scope.LoginUser = JSON.parse(sessionStorage.UserDataSession);
    }
    $scope.UserId = $scope.LoginUser.UserId;
    //$scope.ScreenId = parseInt(sessionStorage.getItem("PaymentGroupScreenId"));
    ...
    function Clear() {
        ...
        $scope.ScreenId = Permission.find(v => v.ScreenName == 'Payment Group').ScreenId;
