app.controller("DeclarationTypeEntryController", function ($scope, $cookieStore, $rootScope, $http, $window) {
    ...
    $scope.UserId = $scope.LoginUser.UserId;
    //$scope.ScreenId = parseInt(sessionStorage.getItem("DeclarationTypeScreenId"));

    Clear();
    function Clear() {
        var PermissionData = sessionStorage.getItem("PermissionDataSession");
        if (PermissionData != null) { var Permission = JSON.parse(sessionStorage.PermissionDataSession); }
        $scope.ScreenId = Permission.find(v => v.ScreenName == 'Declaration Type Entry').ScreenId;
