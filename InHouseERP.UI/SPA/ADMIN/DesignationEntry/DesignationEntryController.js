app.controller("DesignationEntryController", function ($scope, $rootScope, $http, $window) {
    ...
    //$scope.ScreenId = parseInt(sessionStorage.getItem("DesignationScreenId"));
    ...
    function Clear() {
        ...
        $scope.ScreenId = Permission.find(v => v.ScreenName == 'Designation').ScreenId;
    ...
    $scope.reloadBtn = function () {
        $('#textDesignationName').val('');
        $scope.DesignationName = null;
        GetDesignationPaged(1);
    }
    $scope.DesignationSearch = function () {
        GetDesignationPaged(1);
    ...
    function GetDesignationPaged(curPage) {
        ...
        if ($scope.DesignationName != undefined && $scope.DesignationName != "") {
            whereClause = "[DesignationName] LIKE '%" + $scope.DesignationName + "%'"
        }

        $http({
            url: encodeURI('/Designation/GetDesignationPaged?StartRecordNo=' + StartRecordNo + '&RowPerPage=' + $scope.PerPage + '&whereClause=' + whereClause + '&rows=' + 0),
