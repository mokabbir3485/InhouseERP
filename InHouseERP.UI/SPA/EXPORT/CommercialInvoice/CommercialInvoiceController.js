...
app.controller("CommercialInvoiceController", function ($scope, $rootScope, hotkeys, $cookieStore, $http, $filter, $window) {
    ...
    function Clear() {
        ...
        $scope.ScreenId = Permission.find(v => v.ScreenName == 'Commercial Invoice').ScreenId;
    ...
    function ReportNotificationDetail_Get() {
        ...
        $http({
            url: '/EmailSender/ReportNotificationGetByReportCode?ReportCode=' + 'CI',
            method: 'GET',
            headers: { 'Content-Type': 'application/json' }
    ...
    function GetAppNotificationSetupByReportCode() {
        $http({
            url: '/EmailNotificationSetup/GetAppNotificationSetupByReportCode?ReportCode=' + 'CI',
            method: 'GET',
            headers: { 'Content-Type': 'application/json' }
        }).success(function (notification) {
    ...
    $scope.SaveAmendmentRequest = function () {
        ...
        $http.post('/ExpApproval/Save', parms).success(function (data) {
            ...
            if (data > 0) {
                AppNotificationLogPost($scope.PaymentProcessForAmendment, 'Commercial Invoice Amendment Request!');
    ...
    $scope.GetAmendment = function (aCommercialInvoice) {
        ...
        $scope.PaymentProcessForAmendment = {
            ...
            CompanyName: aCommercialInvoice.CompanyName,
            CommercialInvoiceNo: aCommercialInvoice.CommercialInvoiceNo,
            CommercialInvoiceDate: aCommercialInvoice.CommercialInvoiceDate,
        }
    }
    ...
    $scope.SelCommercialInvoice = function (aCommercialInvoice) {
        ...
        var Importer = $scope.companyList.find(x => x.CompanyId == aCommercialInvoice.CompanyId);
        $scope.ddlImporter = Importer;
        $('#ddlImporter').select2('destroy');
        $('#ddlImporter').val(aCommercialInvoice.CompanyId).select2();
    ...
    $scope.OpenPopupWindow = function (ciId) {
        ...
        sessionStorage.setItem("CommercialInvoiceIdCI", JSON.stringify(ciId));
    ...
    function EmailContentForLockAndSubmite() {
        $scope.EmailSendNotification.EmailSubject = "Created Commercial Invoice No: " + $scope.exp_CommercialInvoice.CommercialInvoiceNo;
        ...
        $scope.EmailSendNotification.EmailBody =
            '<p> Dear User,<br/> <strong>A new commercial invoice has been created.</strong> <br/><br/> ' +
            'Commercial Invoice No: <strong > ' + $scope.exp_CommercialInvoice.CommercialInvoiceNo + '</strong><br/>' +
    ...
    function EmailContentForAmendmentRequest() {
        $scope.EmailSendNotification.EmailSubject = "Amendment request for commercial invoice no: " + $scope.PaymentProcessForAmendment.CommercialInvoiceNo;
        ...
        $scope.EmailSendNotification.EmailBody =
            '<p> Dear User,<br/><strong>  An amendment request has been posted for commercial invoice.</strong> <br/><br/> ' +
            'Commercial Invoice No: <strong > ' + $scope.PaymentProcessForAmendment.CommercialInvoiceNo + '</strong><br/>' +
            'Commercial Invoice Date: <strong>' + $scope.PaymentProcessForAmendment.CommercialInvoiceDate + '</strong><br/>' +
            'Company Name: <strong>' + $scope.PaymentProcessForAmendment.CompanyName + '</strong><br/>' +
            'Amendment Reason: <strong>' + $scope.ddlAmendmentReason.AmendmentReasonName + '</strong>' + '<br/>' +
            'Amendment Request Remarks: <strong>' + $scope.exp_AmendmentRequest.RequestRemarks + '</strong>' + '<br/>' +
            'Creator Name: <strong>' + $scope.FullName + '</strong>' + '<br/>' +
            'Created Date: <strong>' + $scope.CreatedDate[0] + '</strong>' + '<br/><br />' +
    ...
    function SaveCommercialInvoice(status) {
        ...
        $http.post('/ExpCommercialInvoice/Post', parms).success(function (data) {
            if (data > 0) {
                if ($scope.exp_CommercialInvoice.IsSubmitted == true) {
                    AppNotificationLogPost($scope.exp_CommercialInvoice, 'Commercial Invoice Created!');
    ...
    $scope.lockAndSubmit = function () {
        ...
        if ($scope.exp_CommercialInvoice.CommercialInvoiceId == 0 && $scope.CreatePermission) {
        ...
        else if ($scope.exp_CommercialInvoice.CommercialInvoiceId == 0 && !$scope.CreatePermission) {
            alertify.log('You do not have permission to save!', 'error', '5000');
        }
        else if ($scope.exp_CommercialInvoice.CommercialInvoiceId > 0 && $scope.RevisePermission) {
            alertify.confirm("Are you sure to lock and submit?", function (e) {
                if (e) {
                    $scope.exp_CommercialInvoice.IsSubmitted = true;
                    SaveCommercialInvoice('Saved');
                ...
                if ($(e.target).is("#ciTable tbody tr td")) {
                    ...
                    $("#ciTable tbody tr").each(function (index) {
                        $(this).hover(function () {
                            ...
                            $scope.SelectedItem = $scope.ItemSearchList.find(x => x.ItemId == $scope.SelectItemId);
