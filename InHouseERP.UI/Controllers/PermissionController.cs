...
namespace Security.UI.Controllers
{
    ...
    */
    public class PermissionController : Controller
    {
        ...
        public JsonResult GetPermissionByRoleIdNew(int roleId)
        {
            try
            {
                var permissionList = Facade.Permission.GetByRoleIdNew(roleId);
                return Json(permissionList, JsonRequestBehavior.AllowGet);
            }
            catch (Exception ex)
            {
        ...
        public int SavePermissionWithDetails(int roleId, List<s_Permission> PermissionLst, List<s_PermissionDetail> DetailList)
        {
            ...
            using (System.Transactions.TransactionScope ts = new System.Transactions.TransactionScope())
            {
                try
                {
                    ...
                    Facade.Permission.DeleteByRoleId(roleId);
