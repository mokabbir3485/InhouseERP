...
namespace Security.UI.Controllers
{
    public class DepartmentController : Controller
    {
        ...
        public JsonResult GetDepartmentPaged(int StartRecordNo,string WhereClause, int RowPerPage, int rows)
        {
            try
            {
                var customMODEntity = new
                {
                    ListData = Facade.Department.GetPaged(StartRecordNo, RowPerPage, WhereClause, "DepartmentId", "DESC", ref rows),
                    TotalRecord = rows
                };
        ...
        [HttpGet]
        public JsonResult DepartmentGetByBranchAndDeptTypeId(string  departmentTypeIds , int? branchId = null)
        {
            try
            {
                var storeList = Facade.Department.DepartmentGetByBranchAndDeptTypeId(departmentTypeIds, branchId);
                return Json(storeList, JsonRequestBehavior.AllowGet);
            }
            catch (Exception ex)
            {
        ...
        [HttpGet]
        public JsonResult GetAllTypeWiseActiveDepartment()
        {
            try
            {
                var storeList = Facade.Department.GetAllTypeWiseActiveDepartment();
                return Json(storeList, JsonRequestBehavior.AllowGet);
            }
            catch (Exception ex)
            {
