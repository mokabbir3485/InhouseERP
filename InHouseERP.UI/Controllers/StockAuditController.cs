...
namespace Security.UI.Controllers
{
    public class StockAuditController : Controller
    {
        ...
        [HttpGet]
        public JsonResult ItemGetCurrentStock(Int32? DepartmentId = null, Int32? ItemId = null, Int32? MaterialTypeId = null, Int32? LabelBrandId = null)
        {
            try
            {
                var list =InventoryBLL.Facade.StockAudit.ItemGetCurrentStock(DepartmentId, ItemId, MaterialTypeId, LabelBrandId);
                return Json(list, JsonRequestBehavior.AllowGet);
            }
            catch (Exception ex)
            {
