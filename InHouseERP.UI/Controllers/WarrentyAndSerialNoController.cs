...
namespace Security.UI.Controllers
{
    public class WarrentyAndSerialNoController : Controller
    {
        ...
        [HttpGet]
        public JsonResult GetAllWarrentryReport(Int64 PBDetailSerialId, Int32 ItemId, bool isLocal)
        {
            try
            {
                var pbDetailList = InventoryBLL.Facade.inv_PurchaseBillDetailSerialBLL.GetAllWarrentryReport(PBDetailSerialId, ItemId, isLocal);
                return Json(pbDetailList, JsonRequestBehavior.AllowGet);
            }
            catch (Exception ex)
            {
        ...
        [HttpPost]
        public Int64 SaveWarrantyAndSerialNo(List<proc_ImportPurchaseBillDetailSerial> inv_PurchaseBillDetailSerial,List<inv_LocalPurchaseBillDetailSerial>inv_localDetailseriallist)
        {
            Int64 ret = 0;
        ...
        [HttpPost]
        public Int64 UpdateWarrantyAndSerialNo(List<proc_ImportPurchaseBillDetailSerial> _inv_PurchaseBillDetailSerial)
        {
            Int64 ret = 0;
            using (System.Transactions.TransactionScope ts = new System.Transactions.TransactionScope())
            {
        ...
        public JsonResult GetWarrantyAndSerialNoDynamic(List<proc_ImportPurchaseBillDetailSerial> pPurchaseBillDetailSerialList)
        {
            try
            {
                proc_ImportPurchaseBillDetailSerial aPurchaseBillDetailSerial = new proc_ImportPurchaseBillDetailSerial();
        ...
        /// //////////////////// Dublicate check
        public JsonResult GetImportWarrantyAndSerialNoDynamic(List<inv_LocalPurchaseBillDetailSerial> pPurchaseBillDetailSerialList)
        {
            try
            {
                inv_LocalPurchaseBillDetailSerial aPurchaseBillDetailSerial = new inv_LocalPurchaseBillDetailSerial();
                foreach (var item in pPurchaseBillDetailSerialList)
                {
                    ...
                    var list = InventoryBLL.Facade.inv_PurchaseBillDetailSerialBLL.ImportGetDynamic(criteria, "SerialNo");
                    if (list.Count > 0)
                    {
                        aPurchaseBillDetailSerial = item;
                        break;
        ...
        public JsonResult GetImportWarrantyAndSerialNoDynamicForSingle(string whereCondition)
        {
            
            try
            {
                var list = InventoryBLL.Facade.inv_PurchaseBillDetailSerialBLL.ImportGetDynamic(whereCondition, "SerialNo");
                return Json(list, JsonRequestBehavior.AllowGet);
            }
            catch (Exception ex)
            {
        ...
        public JsonResult UpdateDepartment(List<proc_ImportPurchaseBillDetailSerial> serialList)
        {
            if (serialList != null)
            {
                var rowInserted = 0;
        ...
        public JsonResult GetWarrantyAndSerialNoPaged(int startRecordNo, int rowPerPage, string whereClause, int rows)
        {
            ...
            try
            {
                ...
                var customMODEntity = new
                {
                    ...
                    ListData = Facade.inv_PurchaseBillDetailSerialBLL.GetPaged(startRecordNo, rowPerPage, whereClause, "PBDetailId", "DESC", ref rows),
                    TotalRecord = rows
                };
