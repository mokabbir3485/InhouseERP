...
namespace Security.UI.Controllers
{
    public class ReorderLevelSetupController : Controller
    {
        ...
        public JsonResult SearchReorderlevel(int depId, int? categoryId, int? subcategoryId, string itemIds)
        {
            try
            {
                var searchResultList = InventoryBLL.Facade.StoreWiseItemReorderLevel.Search(depId, categoryId, subcategoryId, itemIds);
