    ...
    public class BankDocumentController : Controller
    {
        ...
        public Int64 Save(exp_BankDocument exp_BankDocument, List<exp_BankDocumentDetail> exp_BankDocumentDetail)
        {
            ...
            try
            {
                ...
                //exp_BankDocument.ApplicationDate = DateTime.Now;
        ...
        public JsonResult BankDocumentGetPaged(int startRecordNo, int rowPerPage, string whereClause, int rows)
        {
            ...
            try
            {
                ...
                var customMODEntity = new
                {
                    ...
                    ListData = Facade.exp_BankDocument.BankDocumentGetPaged(startRecordNo, rowPerPage, whereClause, "BankDocumentId", "DESC", ref rows),
                    TotalRecord = rows
                };
