    ...
    public class EmployeeController : Controller
    {
        ...
        public JsonResult GetEmployeePaged(int StartRecordNo, int RowPerPage, int rows, string whClause)
        {
            try
            {
                ...
                {
                    ListData = Facade.Employee.GetPaged(StartRecordNo, RowPerPage, whClause, "B.BranchName,DP.DepartmentName,E.FirstName", "ASC", ref rows),
                    TotalRecord = rows
                };
        ...
        public JsonResult GetSectionByDepartmentIds(string departmentIds)
        {
            try
            {
                var sectionList = Facade.ad_DepartmentWiseSection.GetSectionByDepartmentIds(departmentIds);
                return Json(sectionList, JsonRequestBehavior.AllowGet);
            }
            catch (Exception ex)
            {
