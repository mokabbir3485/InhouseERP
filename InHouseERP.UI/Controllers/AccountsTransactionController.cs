...
namespace Security.UI.Controllers
{
    public class AccountsTransactionController : Controller
    {
        ...
        [HttpPost]
        public int Acknowledge(AccountsTransaction accountsTransaction, List<pos_SalesOrder> salesOrderList, List<proc_ImportPurchaseBill> purBillList)
        {
            using (System.Transactions.TransactionScope ts = new System.Transactions.TransactionScope())
            {
                ...
                try
                {
                    ...
                    if (!string.IsNullOrEmpty(voucherNo))
                    {
                        ...
                        {
                            foreach (proc_ImportPurchaseBill item in purBillList)
                            {
                                item.VoucherNo = voucherNo;
