...
namespace Security.UI.Controllers
{
    public class BankAccountController : Controller
    {
        ...
        public JsonResult GetBankAccountPaged(int StartRecordNo, int RowPerPage, string whereClause,int rows)
        {
            try
            {
                var customMODEntity = new
                {
                    ListData = Facade.BankAccountBLL.GetPaged(StartRecordNo, RowPerPage, whereClause, "BankAccountId", "DESC",
                        ref rows),
                    TotalRecord = rows
                };  
