...
namespace Security.UI.Controllers
{
    public class SupplierController : Controller
    {
        ...
        public JsonResult GetBySupplierFormushak_6_6(int? supplierId=null)
        {
            try
            {
                var list = Facade.Supplier.GetBySupplierFormushak_6_6(supplierId);
                return Json(list, "application/json", Encoding.UTF8, JsonRequestBehavior.AllowGet);
            }
            catch (Exception ex)
            {
        ...
        public JsonResult GetSupplierPaged(int StartRecordNo, int RowPerPage, string whereClause, int rows)
        {
            try
            {
                var customMODEntity = new
                {
                    ListData = Facade.Supplier.GetPaged(StartRecordNo, RowPerPage, whereClause, "SupplierName", "ASC", ref rows),
                    TotalRecord = rows
                };
        ...
        public int SaveSupplier(ad_Supplier supplier)
        {
            ...
            if (supplier.TIN == null)
                supplier.TIN = "";
            if (supplier.BIN == null)
                supplier.BIN = "";
            if (supplier.NID == null)
                supplier.NID = "";
            try
            {
        ...
        public JsonResult GetSupplerAddressById(int supplierId)
        {
            try
            {
        ...
        public int SaveSupplerAddress(ad_SupplierAddress supplierAddress)
        {
            ...
            if (supplierAddress.Port == null)
                supplierAddress.Port = "";
            try
            {
