...
namespace Security.UI.Controllers
{
    public class ExpCommercialInvoiceController : Controller
    {
        ...
        public Int64 PostHTMLTableForReport(exp_HTMLTableForReport tableHtmlData)
        {
            
            Int64 ret = 0;
            try
            {
                ret = Facade.exp_CommercialInvoice.PostHTMLTableForReport(tableHtmlData);
        ...
        public JsonResult GetHTMLTableForReport(int DocumentId, string DocType)
        {
            try
            {
                var list = Facade.exp_CommercialInvoice.GetHTMLTableForReport(DocumentId, DocType);
        ...
        public JsonResult GetCommercialInvoicePaged(int startRecordNo, int rowPerPage, string whereClause, int rows)
        {
            ...
            try
            {
                ...
                var customMODEntity = new
                {
                    ...
                    ListData = Facade.exp_CommercialInvoice.GetPaged(startRecordNo, rowPerPage, whereClause, "CommercialInvoiceId", "DESC", ref rows),
                    TotalRecord = rows
                };
        ...
        public JsonResult GetCommercialInvoiceDetailModifiedDataGetByInvoiceId(int invoiceId)
        {
            try
            {
                var list = Facade.exp_CommercialInvoice.GetCommercialInvoiceDetailModifiedDataGetByInvoiceId(invoiceId);
                return Json(list, JsonRequestBehavior.AllowGet);
            }
            catch (Exception ex)
            {
        ...
        public JsonResult TruckChallanGetPaged(int startRecordNo, int rowPerPage, string whereClause, int rows)
        {
            // whereClause = "[SO].[SalesOrderDate] between '2020-10-16' and '2020-10-20'";
            //  whereClause = "[SO].[SalesOrderDate]'2020-10-17' between '20/11/2020'";
            try
            {
                ...
                var customMODEntity = new
                {
                    ...
                    ListData = Facade.exp_TruckChallan.TruckChallanGetPaged(startRecordNo, rowPerPage, whereClause, "TC.TruckChallanId", "DESC", ref rows),
                    TotalRecord = rows
                };
                return Json(customMODEntity, JsonRequestBehavior.AllowGet);
            }
        ...
        [HttpPost]
        public Int64 Post1(exp_CommercialInvoice exp_CommercialInvoice, exp_CommercialInvoiceInfo[] exp_CommercialInvoiceInfo, exp_CommercialInvoiceDetail[] exp_CommercialInvoiceDetail, List<exp_CommercialInvoiceDetail_ModifiedData> modifiedDataList, exp_CommercialInvoiceDetail_TableHtml tableHtmlData, List<exp_POReference> POReferencelist, exp_CommercialInvoice_PackingInfo exp_CommercialInvoice_PackingInfo)
        {
            Int64 ret = 0;
            return ret;
        }
        ...
        public Int64 Post(exp_CommercialInvoice exp_CommercialInvoice, exp_CommercialInvoiceInfo[] exp_CommercialInvoiceInfo, exp_CommercialInvoiceDetail[] exp_CommercialInvoiceDetail, List<exp_CommercialInvoiceDetail_ModifiedData> modifiedDataList, exp_CommercialInvoiceDetail_TableHtml tableHtmlData, List<exp_POReference> POReferencelist, exp_CommercialInvoice_PackingInfo exp_CommercialInvoice_PackingInfo)
        {
            ...
            try
            {
                if (exp_CommercialInvoice.CommercialInvoiceId == 0)
                {
                    ...
                    if (exp_CommercialInvoiceDetail != null)
                    {
                        ...
                        {
                            if (CiDetail.ItemDescription == null) { CiDetail.ItemDescription = ""; }
                            if (CiDetail.ItemDescriptionTwo == null) { CiDetail.ItemDescriptionTwo = ""; }
                            if (CiDetail.CartonSize == null) { CiDetail.CartonSize = ""; }
                ...
                if (modifiedDataList.Count != 0)
                {
                    Facade.exp_CommercialInvoice.DeleteCommercialInvoiceDetailModifiedData(Convert.ToInt64(ret));
                }
        ...
        [HttpPost]
        public JsonResult DeliveryChallanPost(exp_CommercialInvoice exp_DeliveryChallan)
        {
            try
            {

                return Json(Facade.exp_CommercialInvoice.DeliveryChallanPost(exp_DeliveryChallan), JsonRequestBehavior.AllowGet);
            }
            catch (Exception ex)
            {
                error_Log error = new error_Log();
        ...
        public JsonResult DeliveryChallanGetPaged(int startRecordNo, int rowPerPage, string whereClause, int rows)
        {
            // whereClause = "[SO].[SalesOrderDate] between '2020-10-16' and '2020-10-20'";
            //  whereClause = "[SO].[SalesOrderDate]'2020-10-17' between '20/11/2020'";
            try
            {
                ...
                var customMODEntity = new
                {
                    ...
                    ListData = Facade.exp_CommercialInvoice.DeliveryChallanGetPaged(startRecordNo, rowPerPage, whereClause, "DeliveryChallanId", "DESC", ref rows),
                    TotalRecord = rows
                };
                return Json(customMODEntity, JsonRequestBehavior.AllowGet);
            }
