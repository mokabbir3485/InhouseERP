...
namespace Security.UI.Controllers
{
    public class CertificateOfOriginController : Controller
    {
        ...
        public JsonResult GetConsumptionCertificatePaged(int startRecordNo, int rowPerPage, string whereClause, int rows)
        {
            ...
            try
            {
                ...
                var customMODEntity = new
                {
                    ...
                    ListData = Facade.exp_ConsumptionCertificate.GetPaged(startRecordNo, rowPerPage, whereClause, "ConsumptionCertificateId", "DESC", ref rows),
                    TotalRecord = rows
                };
                ...
                if (exp_ConsumptionCertificateRawMaterials != null && exp_ConsumptionCertificateRawMaterials.Count > 0 && ret > 0)
                {
                    foreach (var _exp_ConsumptionCertificateRawMaterials in exp_ConsumptionCertificateRawMaterials)
                    {
                        ...
                        if (_exp_ConsumptionCertificateRawMaterials.ConsumptionCertificateRawMaterialsId == 0)
                        {
                            ...
                            od_ret = Facade.exp_ConsumptionCertificate.AddRawMaterials(_exp_ConsumptionCertificateRawMaterials);
                        }
                        else
                        {
                            Facade.exp_ConsumptionCertificate.UpdateRawMaterials(_exp_ConsumptionCertificateRawMaterials);
                        }
                    ...
                    foreach (var _exp_ConsumptionCertifDescription in _exp_ConsumptionCertificateDescription)
                    {
                        ...
                        //{
                            ...
                            conCerDescription = Facade.exp_ConsumptionCertificate.PostDescription(_exp_ConsumptionCertifDescription);
                        //}
        ...
        public JsonResult GetAllCertificateOforigin()
        {
            ...
            try
            {
                var list = Facade.exp_ConsumptionCertificate.GetAllDescription();
        ...
        public JsonResult ConsumptionCertificateRawMatrialDelete(Int64 ConsumptionCertificateRawMatrialId)
        {
            ...
            try
            {
                var list = Facade.exp_ConsumptionCertificate.DeleteRawMaterials(ConsumptionCertificateRawMatrialId);
        ...
        public JsonResult ConsuptionCertificateRawMatrial(Int64 CommercialInvoiceId)
        {
            ...
            try
            {
                var list = Facade.exp_ConsumptionCertificate.GetByConsumptionCertificateRawMetrialByCiId(CommercialInvoiceId);
        ...
        public JsonResult GetDescriptionOfGoods(int ciId)
        {
            try
            {
                var list = Facade.exp_ConsumptionCertificate.Get_DescriptionOfGoods(ciId);
                return Json(list, JsonRequestBehavior.AllowGet);
            }
        ...
        public JsonResult GetDescriptionOfGoodsUpdate(Int64? ConsumptionCertificateId, Int64? ConsumptionCertificateDescriptionId)
        {
            try
            {
                var list = Facade.exp_ConsumptionCertificate.GetAllDescription(ConsumptionCertificateDescriptionId, ConsumptionCertificateId);
                return Json(list, JsonRequestBehavior.AllowGet);
            }
