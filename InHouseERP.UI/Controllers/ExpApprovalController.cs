...
namespace Security.UI.Controllers
{
    public class ExpApprovalController : Controller
    {
        ...
        public JsonResult GetSalesOrder(string approvalType, string DepartmentName, int SectionId)
        {
            try
            {
                var salesOrder = Facade.exp_Approval.GetSalesOrder(approvalType, DepartmentName, SectionId);
        ...
        [HttpGet]
        public JsonResult GetIwoApprovalType(string approvalType, string DepartmentName, int SectionId)
        {
            try
            {
                var salesOrder = Facade.exp_Approval.GetInternalWorkOrder(approvalType, DepartmentName, SectionId);
                return Json(salesOrder, JsonRequestBehavior.AllowGet);
            }
            catch (Exception ex)
            {
