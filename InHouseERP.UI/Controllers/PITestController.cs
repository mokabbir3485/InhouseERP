...
namespace Security.UI.Controllers
{
    ...
    public class PITestController : ApiController
    {
        ...
        //[HttpGet]
        //public IHttpActionResult GetSalesOrder(string approvalType = "PiAmendment", string DepartmentName = "")
        //{
        //    try
        //    {
        //        var salesOrder = Facade.exp_Approval.GetSalesOrder(approvalType, DepartmentName);
