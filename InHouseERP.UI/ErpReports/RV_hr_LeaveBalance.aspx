...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:ObjectDataSource ID="ds_hr_LeaveBalance" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="GetData" TypeName="InHouseERP.UI.App_Code.DataSet.ds_hr_LeaveBalanceTableAdapters.xRpt_hr_LeaveBalanceTableAdapter" OnSelecting="ObjectDataSource1_Selecting">
                <SelectParameters>
