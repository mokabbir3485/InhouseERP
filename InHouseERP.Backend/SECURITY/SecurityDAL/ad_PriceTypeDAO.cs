...
namespace SecurityDAL
{
    public class ad_PriceTypeDAO //: IDisposible
    {
        ...
        public static ad_PriceTypeDAO GetInstanceThreadSafe
        {
            get
            {
                if (instance == null)
                    lock (lockObj)
                    {
                        if (instance == null) instance = new ad_PriceTypeDAO();
                    }
        ...
        public List<ad_PriceType> GetAll(int? PriceTypeId = null)
        {
            try
            {
                var ad_PriceTypeLst = new List<ad_PriceType>();
                var colparameters = new Parameters[1]
                {
                    new Parameters("@PriceTypeId", PriceTypeId, DbType.Int32, ParameterDirection.Input)
                };
                ad_PriceTypeLst =
                    dbExecutor.FetchData<ad_PriceType>(CommandType.StoredProcedure, "ad_PriceType_Get", colparameters);
        ...
        public List<ad_PriceType> GetDynamic(string whereCondition, string orderByExpression)
        {
            try
            {
                ...
                ad_PriceTypeLst = dbExecutor.FetchData<ad_PriceType>(CommandType.StoredProcedure,
                    "ad_PriceType_GetDynamic", colparameters);
                return ad_PriceTypeLst;
            }
            catch (Exception ex)
            {
            ...
            string sortOrder, ref int rows)
        {
            try
            {
                ...
                ad_PriceTypeLst = dbExecutor.FetchDataRef<ad_PriceType>(CommandType.StoredProcedure,
                    "ad_PriceType_GetPaged", colparameters, ref rows);
                return ad_PriceTypeLst;
            }
            catch (Exception ex)
            {
        ...
        public int Add(ad_PriceType _ad_PriceType)
        {
            ...
            try
            {
                ...
                {
                    new Parameters("@PriceTypeName", _ad_PriceType.PriceTypeName, DbType.String,
                ...
                ret = dbExecutor.ExecuteScalar32(true, CommandType.StoredProcedure, "ad_PriceType_Create",
                    colparameters, true);
        ...
        public int Update(ad_PriceType _ad_PriceType)
        {
            ...
            try
            {
                ...
                ret = dbExecutor.ExecuteNonQuery(CommandType.StoredProcedure, "ad_PriceType_Update", colparameters,
                    true);
                return ret;
            }
            catch (Exception ex)
        ...
        public int Delete(int PriceTypeId)
        {
            try
            {
                ...
                ret = dbExecutor.ExecuteNonQuery(CommandType.StoredProcedure, "ad_PriceType_DeleteById", colparameters,
                    true);
                return ret;
            }
            catch (Exception ex)
